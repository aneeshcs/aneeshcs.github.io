...
sections:
  - block: markdown
    ...
    content:
      title: ""
      text: |
        <div style="width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; min-height: 100vh; display: flex; align-items: center; justify-content: center; background: url('/media/rotating-earth-realistic.gif') no-repeat center center; background-size: cover;">
