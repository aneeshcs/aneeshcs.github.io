...
sections:
  - block: markdown
    ...
    content:
      title: ""
      text: |
        <div class="hero-fullwidth" style="position: relative; min-height: 85vh; display: flex; align-items: center; justify-content: flex-start; background: url('/media/hero-bg.png') no-repeat center center; background-size: cover; padding: 4rem;">
          <div style="max-width: 550px; padding: 2.5rem; background: rgba(0,0,0,0.7); border-radius: 12px; margin-left: 5%;">
