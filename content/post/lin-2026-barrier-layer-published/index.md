...
![Cross-section of the upper ocean showing a thin fresh cap above the mixed layer, the barrier layer beneath it, and cold thermocline water below, with an upward arrow blocked at the barrier layer. Profiles at right show temperature uniform down to the thermocline while salinity rises at a shallower depth.](barrier-layer-anatomy.svg "The barrier layer is the gap between two depths: the base of the density-mixed layer, set by the fresh cap, and the top of the thermocline. Conceptual schematic, not to scale.")
...
![Two equatorial Pacific cross-sections comparing observations with coupled models. In the models the warm pool eastern edge sits further west, the barrier layer is thinner, rainfall is weaker, easterly winds are stronger, and the upper western Pacific is saltier.](warm-pool-model-bias.svg "Models keep the upper western Pacific too salty, which thins the barrier layer and holds the warm pool edge too far west. Conceptual schematic, not to scale.")
...
![Timeline in months relative to the peak eastward extent of the warm pool edge. Westerly wind, precipitation and upper-ocean freshening anomalies emerge 10 to 13 months beforehand, peak with the shift, and persist a further nine to 10 months.](precursor-timeline.svg "Westerlies, rainfall and freshening lead the warm pool's eastward shift by 10 to 13 months. Schematic of the lead-lag relationship; curves are illustrative.")
...
![Map of the tropical Pacific with the warm pool in the west and the cold tongue in the east, showing the TEPEX-Central domain over the central basin and the TEPEX-East domain over the eastern basin.](tepex-domains.svg "TEPEX-C targets the ocean mixed and barrier layers and the jets that move the warm pool edge; TEPEX-E targets the cold tongue. Domains indicative.")
