...
publishDate: '2026-01-12T05:46:55.276772Z'
...
abstract: This study quantifies, from a systematic set of regional    ocean-atmosphere
  ...
  SST variation (dSST) is to raise time-mean SST and latent heat flux (LH) prior to
  ...
  (MSE) budget analysis confirms the critical role of diurnal SST variability in the
  ...
  with a diurnal cycle strongly influences the onset and intensity of MJO convection
  is consistent with previous studies that identified an improved representation of
...
tags:
- Deep convection; Diurnal effects; Madden-Julian oscillation; Air-sea    interaction;
